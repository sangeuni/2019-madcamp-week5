...
public class CameraMotion : MonoBehaviour
{
    ...
    public GameObject monkey1, monkey2;
    ...
    private void Update()
    {
        ...
        if(Input.GetKeyDown(KeyCode.A))
        {
            if (monkey1_left.enabled)
            {
                ...
                monkey1.GetComponent<Rigidbody>().transform.Translate(0, 120f * Time.deltaTime, 0);
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.W))
        {
            if (monkey1_right.enabled)
            {
                ...
                //monkey1.GetComponent<Rigidbody>().AddForce(Vector3.right * 12);
                monkey1.GetComponent<Rigidbody>().transform.Translate(0, 0, 120f * Time.deltaTime);
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.LeftArrow))
        {
            if (monkey2_left.enabled)
            {
                ...
                monkey2.GetComponent<Rigidbody>().transform.Translate(0, -120f * Time.deltaTime, 0);
            }
        }
        ...
        if (Input.GetKeyDown(KeyCode.UpArrow))
        {
            if (monkey2_right.enabled)
            {
                ...
                //monkey1.GetComponent<Rigidbody>().AddForce(Vector3.right * 12);
                monkey2.GetComponent<Rigidbody>().transform.Translate(0, 0, 120f * Time.deltaTime);
            }
        }
